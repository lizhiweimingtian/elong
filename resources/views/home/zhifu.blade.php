	        ...
	        <div class="pay_top">
	            <div class="pay_top_info">
	                ...
	                <div class="pay_info_box js_info_box" style="display: none;">
	                    <p><b>订单号：</b>31020202</p>
	                    <p><b>产品名称：</b>北京怀柔白河峡谷漂流、青石岭短漂单人票</p>
	                    
		                    <p><b id="visitTime">游玩时间：</b>2016-08-27</p>
	                    
	                </div>
	                <div class="pay_info_box">
	                    <p><b>订单金额：</b><small>¥</small>&nbsp;<span class="c_333">58.00</span></p>
	            ...
	            <div class="pay_top_zfb">
		                ...
		                <iframe src="index_1a.html" id="alipayIframe" name="alipayIframe" scrolling="no" style="height: 157px; overflow: hidden; margin-top: 18px; margin-left: 18px;" frameborder="0" height="157px" width="157px"></iframe>
        	...
        	<div class="pay_box">
        		<ul class="pay_type_tab">
	            	...
	            	<!-- 网银支付begin -->
		                ...
		                <a class="btn btn-lg btn-orange btn_next" onclick="selectBanks(this, 'ONLINE_PAY_UL')">下一步</a>
