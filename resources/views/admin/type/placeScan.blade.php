<html>
    ...
    <body>
        ...
        <table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
            <tr>
                <td width="99%" align="left" valign="top">您的位置：景点管理&nbsp;&nbsp;>&nbsp;&nbsp;查看景点详情</td>
            </tr>
            <tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                            <tr onMouseOut="this.style.backgroundColor = '#ffffff'" onMouseOver="this.style.backgroundColor = '#edf5ff'">
                                ...
                                <td align="left" valign="middle" class="borderright borderbottom main-for">
                                   {{$detail->place_name or $data->name}}
                                </td>
                            </tr>
                            <tr onMouseOut="this.style.backgroundColor = '#ffffff'" onMouseOver="this.style.backgroundColor = '#edf5ff'">
                            ...
                            <tr onMouseOut="this.style.backgroundColor = '#ffffff'" onMouseOver="this.style.backgroundColor = '#edf5ff'">
                                ...
                                <td align="left" valign="middle" class="borderright borderbottom main-for">
                                    ...
                                    <div id="preview"><img src="{{$detail->photo_path or ""}}" style="width:200px;height:150px"/></div>
                            ...
                            <tr onMouseOut="this.style.backgroundColor = '#ffffff'" onMouseOver="this.style.backgroundColor = '#edf5ff'">
                                ...
                                <td align="left" valign="middle" class="borderright borderbottom main-for">
                                    第一天&nbsp;: {{$detail->day1 or ""}}<br/>
                                    第二天&nbsp;: {{$detail->day2 or ""}}<br/>
                                    第三天&nbsp;: {{$detail->day3 or ""}}<br/>
                                    第四天&nbsp;: {{$detail->day3 or ""}}<br/>
                                </td>
                            </tr>
                            <tr onMouseOut="this.style.backgroundColor = '#ffffff'" onMouseOver="this.style.backgroundColor = '#edf5ff'">
                                ...
                                <td align="left" valign="middle" class="borderright borderbottom main-for">
                                    <div name="">
                                   <?php echo htmlspecialchars_decode($detail->editorValue); ?>
                            ...
                            <tr onMouseOut="this.style.backgroundColor = '#ffffff'" onMouseOver="this.style.backgroundColor = '#edf5ff'">
                                ...
                                <td align="left" valign="middle" class="borderright borderbottom main-for">
                                    <a onFocus="this.blur()" class="add" href="/type_place_edit?id={{$detail->place_id or $data->id}}" ><b> 去 修 改 </b> </a>
