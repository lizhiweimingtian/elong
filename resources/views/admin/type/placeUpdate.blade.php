<html>
    ...
    <body>
        ...
        <table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
            <tr>
                <td width="99%" align="left" valign="top">您的位置：景点管理&nbsp;&nbsp;>&nbsp;&nbsp;修改景点详情</td>
            </tr>
            <tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                            <tr onMouseOut="this.style.backgroundColor = '#ffffff'" onMouseOver="this.style.backgroundColor = '#edf5ff'">
                                ...
                                <td align="left" valign="middle" class="borderright borderbottom main-for">
                                    ...
                                    <input type="text" id="place" name="place_name" value="{{$detail->name}}" class="text-word">
                                </td>
                            </tr>
                            <tr onMouseOut="this.style.backgroundColor = '#ffffff'" onMouseOver="this.style.backgroundColor = '#edf5ff'">
                                <td align="right" valign="middle" class="borderright borderbottom bggray">景 点 标 题：</td>
                                <td align="left" valign="middle" class="borderright borderbottom main-for">
                                    <input type="text" name="title" id="title" value="{{$detail->title}}"  style="width:650px;height:45px">
                                </td>
                            </tr>

                            <tr onMouseOut="this.style.backgroundColor = '#ffffff'" onMouseOver="this.style.backgroundColor = '#edf5ff'">
                                <td align="right" valign="middle" class="borderright borderbottom bggray">优 惠 促 销：</td>

                                <td align="left" valign="middle" class="borderright borderbottom main-for">
                                    <input type="text" name="saleinfo" value="{{$detail->saleinfo}}" style="width:650px;height:45px">
                                </td>
                            </tr>
                            ...
                            <tr onMouseOut="this.style.backgroundColor = '#ffffff'" onMouseOver="this.style.backgroundColor = '#edf5ff'">
                                ...
                                <td align="left" valign="middle" class="borderright borderbottom main-for">
                                    ...
                                    <input type="text"  name="photo_path" id="photo_path" value="{{$detail->photo_path}}" class="text-word">
                                </td>
                            </tr>
                            
                            <tr onMouseOut="this.style.backgroundColor = '#ffffff'" onMouseOver="this.style.backgroundColor = '#edf5ff'">
                                <td align="right" valign="middle" class="borderright borderbottom bggray">图 说 风 景：</td>
                                <td align="left" valign="middle" class="borderright borderbottom main-for">   
                                    <input type="text"  name="photoinfo" id="phpto_info" value="{{$detail->photoinfo}}"style="width:650px;height:45px">
                                </td>
                            </tr>
                            ...
                            <tr onMouseOut="this.style.backgroundColor = '#ffffff'" onMouseOver="this.style.backgroundColor = '#edf5ff'">
                                ...
                                <td align="left" valign="middle" class="borderright borderbottom main-for">
                                    第一天<input type="text"  name="day1"  value="{{$detail->day1}}" style="width:290px;height:40px">
                                    第二天<input type="text"  name="day2"  value="{{$detail->day2}}" style="width:290px;height:40px">
                                    第三天<input type="text"  name="day3"  value="{{$detail->day3}}" style="width:290px;height:40px"> 
                                </td>
                            </tr>
                            <tr onMouseOut="this.style.backgroundColor = '#ffffff'" onMouseOver="this.style.backgroundColor = '#edf5ff'">
                                ...
                                <td align="left" valign="middle" class="borderright borderbottom main-for">
                                    <div name="">
                                        <script id="editor" type="text/plain" style="width:1024px;height:500px;" value="{{$detail->editorValue}}"></script>
                                    </div>
