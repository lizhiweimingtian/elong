  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
     ...
     @foreach($places as $tmp)	  
      <tr class="bggray">
        <td align="left" valign="middle" class="borderright borderbottom tdb"><img src="" width="15" height="13"></td>
		...
		<a href="/type_addChild?pid={{ $tmp->id }}" target="mainFrame" onFocus="this.blur()" class="add">添加子版块</a><span class="gray">&nbsp;|&nbsp;</span>
