...
<!--top样式-->
	<frame src="/top" name="topframe" scrolling="no" noresize id="topframe" title="topframe" />
<!--contact样式-->
	<frameset id="attachucp" framespacing="0" border="0" frameborder="no" cols="194,12,*" rows="*">
		<frame scrolling="auto" noresize="" frameborder="no" name="leftFrame" src="/left"></frame>
		<frame id="leftbar" scrolling="no" noresize="" name="switchFrame" src="/swich"></frame>
		<frame scrolling="auto" noresize="" border="0" name="mainFrame" src="/main"></frame>
	</frameset>
<!--bottom样式-->
