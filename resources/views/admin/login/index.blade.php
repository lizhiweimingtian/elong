...
<body>
    {{ session("info") }}      
    <form id="form1" runat="server" action="/adm/logTodo" method="post">
            ...
            <li class="topD">
                <ul class="login">
					...
					<li><span class="left login-text">验证码：</span> <span style="left">
                       <input id="Text3" style=" width: 100px; height:40px;" type="text" name="code"/><img src="{{ url('/adm/login/captcha')."/". rand() }}" id="code" onclick="this.src = this.src.replace(/\d+$/, '') + Math.random();" align="top" />			   
                    </span></li>
                </ul>
            </li>
            <li class="topE"></li>
