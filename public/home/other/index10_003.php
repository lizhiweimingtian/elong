$(function(){var startfooter='<!-- 公共底部  --><div class="footer-inner wrap">',copyinfo='<div class="copyinfo" style="margin:10px auto 10px;"><img src="http://pic.lvmama.com/img/v3/copyinfo.png" width="1000" height="70"></div>',footerlink='<p class="footer-link">'
...
+'</p>',copyright='<p class="lv-copyright">Copyright &copy; 2016 www.lvmama.com. 上海景域文化传播股份有限公司版权所有&#12288;<a href="http://www.miitbeian.gov.cn" target="_blank" rel="nofollow">沪ICP备13011172号-3</a>&#12288;增值电信业务经营许可证编号：<a rel="nofollow" href="http://pic.lvmama.com/img/ICP.jpg" target="_blank">沪B2-20100030</a></p>',safety='<div class="lv-safety">'
...
+'</div>',endfooter='</div><!-- 公共底部结束  -->';$("#lv-footer").html(startfooter+copyinfo+footerlink+copyright+safety+endfooter);$("#order-footer").html(startfooter+copyright+safety+endfooter);});